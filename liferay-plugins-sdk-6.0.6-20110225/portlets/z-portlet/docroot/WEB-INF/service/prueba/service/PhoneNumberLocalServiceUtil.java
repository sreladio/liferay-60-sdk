...
/**
 * The utility for the phone number local service. This utility wraps {@link prueba.service.impl.PhoneNumberLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 * Never modify this class directly. Add custom service methods to {@link prueba.service.impl.PhoneNumberLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
 * </p>
 *
 * <p>
 ...
 * @see prueba.service.base.PhoneNumberLocalServiceBaseImpl
 * @see prueba.service.impl.PhoneNumberLocalServiceImpl
 * @generated
 */
public class PhoneNumberLocalServiceUtil {
	/**
	...
	*/
	public static prueba.model.PhoneNumber addPhoneNumber(
		prueba.model.PhoneNumber phoneNumber)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addPhoneNumber(phoneNumber);
	}
	...
	*/
	public static prueba.model.PhoneNumber createPhoneNumber(
		java.lang.String numberId) {
		return getService().createPhoneNumber(numberId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deletePhoneNumber(java.lang.String numberId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deletePhoneNumber(numberId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deletePhoneNumber(prueba.model.PhoneNumber phoneNumber)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deletePhoneNumber(phoneNumber);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static prueba.model.PhoneNumber getPhoneNumber(
		java.lang.String numberId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getPhoneNumber(numberId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<prueba.model.PhoneNumber> getPhoneNumbers(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getPhoneNumbers(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getPhoneNumbersCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getPhoneNumbersCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static prueba.model.PhoneNumber updatePhoneNumber(
		prueba.model.PhoneNumber phoneNumber)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updatePhoneNumber(phoneNumber);
	}
	...
	*/
	public static prueba.model.PhoneNumber updatePhoneNumber(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updatePhoneNumber(phoneNumber, merge);
	}
	...
	public static PhoneNumberLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.SERVLET_CONTEXT_NAME,
					PhoneNumberLocalService.class.getName());
			ClassLoader portletClassLoader = (ClassLoader)PortletBeanLocatorUtil.locate(ClpSerializer.SERVLET_CONTEXT_NAME,
					"portletClassLoader");

			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					PhoneNumberLocalService.class.getName(), portletClassLoader);

			_service = new PhoneNumberLocalServiceClp(classLoaderProxy);
	...
	public void setService(PhoneNumberLocalService service) {
		_service = service;
	}

	private static PhoneNumberLocalService _service;
}
...
/**
 * The utility for the u s phone number local service. This utility wraps {@link com.oldschool.user.registration.service.impl.USPhoneNumberLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 * Never modify this class directly. Add custom service methods to {@link com.oldschool.user.registration.service.impl.USPhoneNumberLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
 * </p>
 *
 * <p>
 ...
 * @generated
 */
public class USPhoneNumberLocalServiceUtil {
	/**
	...
	*/
	public static com.oldschool.user.registration.model.USPhoneNumber addUSPhoneNumber(
		com.oldschool.user.registration.model.USPhoneNumber usPhoneNumber)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addUSPhoneNumber(usPhoneNumber);
	}
	...
	*/
	public static com.oldschool.user.registration.model.USPhoneNumber createUSPhoneNumber(
		java.lang.String numberId) {
		return getService().createUSPhoneNumber(numberId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteUSPhoneNumber(java.lang.String numberId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteUSPhoneNumber(numberId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteUSPhoneNumber(
		com.oldschool.user.registration.model.USPhoneNumber usPhoneNumber)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteUSPhoneNumber(usPhoneNumber);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.oldschool.user.registration.model.USPhoneNumber getUSPhoneNumber(
		java.lang.String numberId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getUSPhoneNumber(numberId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.oldschool.user.registration.model.USPhoneNumber> getUSPhoneNumbers(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getUSPhoneNumbers(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getUSPhoneNumbersCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getUSPhoneNumbersCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.oldschool.user.registration.model.USPhoneNumber updateUSPhoneNumber(
		com.oldschool.user.registration.model.USPhoneNumber usPhoneNumber)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateUSPhoneNumber(usPhoneNumber);
	}
	...
	*/
	public static com.oldschool.user.registration.model.USPhoneNumber updateUSPhoneNumber(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateUSPhoneNumber(usPhoneNumber, merge);
	}
	...
	public static USPhoneNumberLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.SERVLET_CONTEXT_NAME,
					USPhoneNumberLocalService.class.getName());
			...
			_service = new USPhoneNumberLocalServiceClp(classLoaderProxy);
	...
	public void setService(USPhoneNumberLocalService service) {
		_service = service;
	}

	private static USPhoneNumberLocalService _service;
}
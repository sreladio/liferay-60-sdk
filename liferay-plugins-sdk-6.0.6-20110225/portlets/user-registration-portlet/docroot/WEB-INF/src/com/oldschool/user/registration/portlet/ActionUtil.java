...
public class ActionUtil {
	...
	public static USMember memberFromRequest(ActionRequest request) throws com.liferay.portal.kernel.exception.PortalException {
		...
		Date finalJavaDate = PortalUtil.getDate(month, day, year, new PortalException());
		Date finalSQLDate = new java.sql.Date(finalJavaDate.getTime());
		
		member.setMemberBirthDate(finalSQLDate);
		//member.setMemberBirthDate(finalJavaDate);

...
import com.oldschool.user.registration.model.USMemberClp;
...
public class ClpSerializer {
	public static final String SERVLET_CONTEXT_NAME = "user-registration-portlet";
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(USMemberClp.class.getName())) {
			USMemberClp oldCplModel = (USMemberClp)oldModel;
			...
			try {
				...
				try {
					Class<?> newModelClass = Class.forName("com.oldschool.user.registration.model.impl.USMemberImpl",
							true, _classLoader);
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.oldschool.user.registration.model.impl.USMemberImpl")) {
			ClassLoader contextClassLoader = Thread.currentThread()
												   .getContextClassLoader();
			...
			try {
				...
				try {
					USMemberClp newModel = new USMemberClp();

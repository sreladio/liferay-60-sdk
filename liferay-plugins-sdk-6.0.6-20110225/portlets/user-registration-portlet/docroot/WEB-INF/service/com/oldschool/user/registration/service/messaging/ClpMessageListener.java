...
package com.oldschool.user.registration.service.messaging;
...
import com.oldschool.user.registration.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			USMemberLocalServiceUtil.clearService();
		}
	}

...
public class PRProductLocalServiceClp implements PRProductLocalService {
	public PRProductLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addPRProductMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addPRProduct",
				com.oldschool.internet.productregistration.model.PRProduct.class);
	...
	public com.oldschool.internet.productregistration.model.PRProduct addPRProduct(
		...
		return (com.oldschool.internet.productregistration.model.PRProduct)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.oldschool.internet.productregistration.model.PRProduct> getPRProducts(
		...
		return (java.util.List<com.oldschool.internet.productregistration.model.PRProduct>)ClpSerializer.translateOutput(returnObj);
	}

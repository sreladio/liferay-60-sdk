...
/**
 * The utility for the member local service. This utility wraps {@link prueba.service.impl.MemberLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 * Never modify this class directly. Add custom service methods to {@link prueba.service.impl.MemberLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
 * </p>
 *
 * <p>
 ...
 * @see prueba.service.base.MemberLocalServiceBaseImpl
 * @see prueba.service.impl.MemberLocalServiceImpl
 * @generated
 */
public class MemberLocalServiceUtil {
	...
	*/
	public static prueba.model.Member addMember(prueba.model.Member member)
	...
	*/
	public static prueba.model.Member createMember(long memberId) {
	...
	*/
	public static void deleteMember(long memberId)
		...
		getService().deleteMember(memberId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteMember(prueba.model.Member member)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteMember(member);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static prueba.model.Member getMember(long memberId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<prueba.model.Member> getMembers(int start,
		int end) throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static prueba.model.Member updateMember(prueba.model.Member member)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	public static MemberLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					MemberLocalService.class.getName(), portletClassLoader);

			_service = new MemberLocalServiceClp(classLoaderProxy);
